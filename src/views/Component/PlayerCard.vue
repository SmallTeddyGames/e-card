...
<template>
  <div grid="~ cols-5 gap-5">
    <img w-120px relative cursor-pointer transition-top-500 v-for="cardItem in cardItems"
      :class="cardItem.isClick ? 'top--20px' : 'top-0'" :alt="cardItem.role" :src="getAssetsFile(cardItem.img)"
