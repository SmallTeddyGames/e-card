      ...
      <div class="relative w-600px max-w-90vw rounded-3xl overflow-hidden animate-bounce-in"
        ...
        <div class="p-4 sm:p-8">
          ...
          <div class="text-center mb-6 sm:mb-8">
            ...
            <div class="text-white-70 text-base sm:text-lg">
          ...
          <div class="flex items-center justify-center gap-4 sm:gap-8 mb-6 sm:mb-8">
            ...
            <div class="text-center">
              ...
              <div class="text-white font-bold text-sm sm:text-lg">{{ t('info.player') }}</div>
              <div class="gold-text text-2xl sm:text-4xl font-black mt-1">{{ playerFinalScore }}</div>
            </div>

            <!-- VS -->
            <div class="text-gold text-xl sm:text-3xl font-black animate-pulse">VS</div>
            ...
            <div class="text-center">
              ...
              <div class="text-white font-bold text-sm sm:text-lg">{{ t('info.computer') }}</div>
              <div class="text-red-400 text-2xl sm:text-4xl font-black mt-1">{{ computerFinalScore }}</div>
            </div>
          </div>
          ...
          <div class="rounded-2xl p-4 sm:p-6 mb-4 sm:mb-6"
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-2 sm:gap-3">
                ...
                <span class="text-white-80 font-bold text-sm sm:text-lg">{{ t('settle.beans') }}</span>
              </div>
              <div class="text-right">
                <div class="text-white-60 text-xs sm:text-sm">{{ t('settle.remaining') }}</div>
                <div class="gold-text text-xl sm:text-3xl font-black">{{ state.playerBeans }}</div>
              </div>
            </div>
            <div class="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-white-10 flex items-center justify-between">
              <span class="text-white-70 text-sm">{{ t('settle.beansChange') }}</span>
              <span class="text-lg sm:text-2xl font-bold" :class="beansChange >= 0 ? 'text-green-400' : 'text-red-400'">
          ...
          <div class="grid grid-cols-3 gap-2 sm:gap-4 mb-6 sm:mb-8">
            <div class="text-center p-2 sm:p-4 rounded-xl" style="background: rgba(0,255,136,0.1); border: 1px solid rgba(0,255,136,0.2);">
              <div class="text-green-400 text-xl sm:text-3xl font-black">{{ state.totalWins }}</div>
              <div class="text-white-60 text-xs sm:text-sm mt-1">{{ t('settle.totalWins') }}</div>
            </div>
            <div class="text-center p-2 sm:p-4 rounded-xl" style="background: rgba(255,100,100,0.1); border: 1px solid rgba(255,100,100,0.2);">
              <div class="text-red-400 text-xl sm:text-3xl font-black">{{ state.totalLosses }}</div>
              <div class="text-white-60 text-xs sm:text-sm mt-1">{{ t('settle.totalLosses') }}</div>
            </div>
            <div class="text-center p-2 sm:p-4 rounded-xl" style="background: rgba(255,215,0,0.1); border: 1px solid rgba(255,215,0,0.2);">
              <div class="gold-text text-xl sm:text-3xl font-black">{{ state.rounds - 1 }}</div>
              <div class="text-white-60 text-xs sm:text-sm mt-1">{{ t('settle.roundsPlayed') }}</div>
            </div>
          </div>
          ...
          <div class="flex gap-2 sm:gap-4">
            <button
              class="flex-1 py-3 sm:py-4 rounded-xl font-bold text-base sm:text-lg text-white transition-all duration-300 hover:scale-105 active:scale-95"
